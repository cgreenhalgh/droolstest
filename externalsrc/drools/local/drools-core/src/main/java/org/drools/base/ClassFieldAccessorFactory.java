        ...
        try {
            ...
            if ( SELF_REFERENCE_FIELD.equals( fieldName ) ) {
                ...
                if ( fieldType != null && getterMethod != null ) {
                    // BEGIN ANDROID FIX - no defineClass!
                	if (System.getProperty("java.vm.name")!=null && System.getProperty("java.vm.name").startsWith("Dalvik")) {
                		return new BaseClassFieldReader ( clazz, fieldName ) {
                		    public Object getValue(InternalWorkingMemory workingMemory, Object object) {
                		    	try {
                		    		return getterMethod.invoke(object);
                		    	}
                		    	catch (Exception e) {
                		    		throw new RuntimeDroolsException("Error getting "+fieldName+" from "+object+": "+e);
                		    	}
                		    }
                		    ...
                		    {
                		    	return ((Character)getValue(workingMemory, object)).charValue();
                		    }

                		    public int getIntValue(InternalWorkingMemory workingMemory, Object object) {
                		    	return ((Number)getValue(workingMemory, object)).intValue();
                		    }

                		    public byte getByteValue(InternalWorkingMemory workingMemory, Object object){
                		    	return ((Number)getValue(workingMemory, object)).byteValue();
                		    }

                		    public short getShortValue(InternalWorkingMemory workingMemory, Object object){
                		    	return ((Number)getValue(workingMemory, object)).shortValue();
                		    }

                		    public long getLongValue(InternalWorkingMemory workingMemory, Object object) {
                		    	return ((Number)getValue(workingMemory, object)).longValue();
                		    }

                		    public float getFloatValue(InternalWorkingMemory workingMemory, Object object){
                		    	return ((Number)getValue(workingMemory, object)).floatValue();
                		    }

                		    public double getDoubleValue(InternalWorkingMemory workingMemory, Object object) {
                		    	return ((Double)getValue(workingMemory, object)).doubleValue();
                		    }

                		    public boolean getBooleanValue(InternalWorkingMemory workingMemory, Object object){
                		    	return ((Boolean)getValue(workingMemory, object)).booleanValue();
                		    }
    ...
    public BaseClassFieldWriter getClassFieldWriter(final Class< ? > clazz,
        ...
        try {
            ...
            if ( setterMethod != null ) {
        		// BEGIN ANDROID FIX - no defineClass!
        		if (System.getProperty("java.vm.name")!=null && System.getProperty("java.vm.name").startsWith("Dalvik")) {
        			return new BaseClassFieldWriter(clazz, fieldName) {
        			    ...
        			    { 
        			    	try {
        			    		...
        			    		throw new RuntimeDroolsException("doing setValue("+bean+","+value+"): "+e);
        			    	}
        			    }
